...
// login.php
session_start();
require __DIR__ . '/lib/csrf.php';  // must expose csrf_token()

$errors = $_SESSION['form_errors'] ?? [];   // ['email'=>..,'password'=>..,'general'=>..]
...
<body>
  <div class="auth-wrap">
    ...
    <section class="auth-panel">
      <div class="auth-card">
        ...
        <!-- Regular POST to backend -->
        <form id="loginForm" action="auth/login.php" method="post" autocomplete="on">
  ...
  <!-- JS (password toggle + brand/h1 parallax only) -->
